  ...
  return (
    <div className="flex flex-col gap-4 w-full h-full">
      <div className="flex-1 flex flex-col">
        <label className="block font-poppins font-semibold text-starkids-blueDark mb-2 text-sm uppercase flex justify-between">
        ...
        <div className="relative flex-1 w-full shadow-inner rounded-xl overflow-hidden border-2 border-starkids-blue/20 focus-within:border-starkids-purple/50 focus-within:ring-2 focus-within:ring-starkids-purple/20 transition-all">
          <textarea
            value={text}
