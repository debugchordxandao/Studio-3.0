...
export const exportAsPDF = async (elementId: string, fileName: string = 'aula-starkids.pdf') => {
    ...
    try {
        ...
        alert('Erro ao gerar PDF. Verifique se a biblioteca "html2canvas" está instalada (npm install html2canvas).');
    }
};
...
export const exportAsPNG = async (elementId: string, fileName: string = 'aula-starkids.png') => {
    ...
    try {
        ...
        alert('Erro ao gerar Imagem. Verifique se a biblioteca "html2canvas" está instalada (npm install html2canvas).');
    }
};

export const exportAsDOCX = async (editorId: string, fileName: string = 'aula-starkids.docx') => {
    ...
    try {
        ...
        console.error(e);
        alert("Erro ao gerar arquivo Word. Verifique se a biblioteca 'html-docx-js-typescript' está instalada (npm install html-docx-js-typescript).");
    }
};
