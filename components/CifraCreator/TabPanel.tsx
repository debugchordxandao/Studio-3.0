        ...
        <div className="flex flex-col gap-4 w-full">
            <div className="bg-gray-50 p-3 rounded-xl shadow-inner border border-gray-200 overflow-x-auto">
               ...
               */}
                            ...
                            <div className="w-6 text-center font-bold text-sky-700 font-poppins shrink-0 select-none z-10 bg-gray-50">
                                {TAB_STRINGS[rIndex]}
                            </div>
            ...
            <div className="flex gap-2">
                ...
                <button
                    ...
                    className="flex-[2] font-lobster text-lg py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-full shadow-[0_3px_0_#e65100] active:shadow-none active:translate-y-1 transition-all flex items-center justify-center gap-2"
                >
                    <span>Inerir</span>
