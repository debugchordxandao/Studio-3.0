    ...
    return (
        <div className="flex flex-col items-center gap-4 w-full">
            <div className="w-full">
                <label className="block font-poppins font-semibold text-sky-700 mb-2 text-sm uppercase">
                    Selecione o Acorde:
                </label>
                <select
                    value={selectedChord}
                    onChange={(e) => setSelectedChord(e.target.value)}
                    className="w-full font-poppins p-2 border-2 border-sky-500 rounded-xl bg-sky-100 text-sky-700 outline-none focus:ring-2 focus:ring-purple-500"
                >
            ...
            <button
                ...
                className="w-full font-lobster text-lg py-2 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-[0_3px_0_#2e7d32] active:shadow-none active:translate-y-1 transition-all"
            >
                Inserir Acorde
            </button>
        </div>
