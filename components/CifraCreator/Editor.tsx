...
const Editor = forwardRef<EditorRef, EditorProps>((props, ref) => {
    ...
    return (
        <div className="flex flex-col items-center w-full relative">
            ...
            {/* --- TOOLBAR (STICKY) --- */}
            <div
                className="sticky top-28 z-40 bg-white rounded-full shadow-xl border border-gray-200 px-6 py-3 flex items-center gap-6 mb-8"
            >
                ...
                <div className="flex items-center gap-2 bg-blue-50 p-1 rounded-full px-4">
                    ...
                    <button
                        ...
                        className="text-xs font-bold text-gray-600 hover:text-sky-600 transition-colors px-1"
                        title="Pequeno"
                    >
                        A
                    </button>
                    <button
                        ...
                        className="text-base font-bold text-gray-600 hover:text-sky-600 transition-colors px-1"
                        title="Normal"
                    >
                        A
                    </button>
                    <button
                        ...
                        className="text-xl font-bold text-gray-600 hover:text-sky-600 transition-colors px-1"
                        title="Grande"
                    >
                        A
                    </button>
            ...
            <div className="w-full flex justify-center">
                ...
                <div
                    ref={editorRef}
                    contentEditable
                    className="bg-white shadow-2xl w-full max-w-[800px] min-h-[1100px] p-12 outline-none font-poppins text-gray-800 mb-20"
                    style={{
                        width: '210mm',
                        minHeight: '297mm',
                    }}
